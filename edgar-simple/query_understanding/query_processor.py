...
class QueryProcessor:
    ...
    def process_query(self, query: str) -> QueryResult:
        ...
        analysis = self._analyze_filings(filings, parsed_query, query)
    ...
    def _parse_query(self, query: str) -> Dict[str, Any]:
        ...
        accounting_concepts = []
        if "asc 606" in query_lower or "accounting standards" in query_lower or "revenue recognition" in query_lower:
            accounting_concepts.append("ASC 606")
        if "asc 842" in query_lower or "lease accounting" in query_lower:
    ...
    def _analyze_filings(self, filings: List[Dict[str, Any]], parsed_query: Dict[str, Any], query: str) -> Dict[str, Any]:
        ...
        if "policy" in str(parsed_query).lower() or "policies" in str(parsed_query).lower() or "accounting standards" in str(parsed_query).lower() or "what" in str(parsed_query).lower() or "accounting standards" in query.lower():
